  ...
  return (
    <div className="*:outline-none *:box-border *:p-0 *:m-0 font-serif select-none">
      <div className="flex w-full items-center h-screen bg-[#080710]">
        ...
        <form onSubmit={login} className="min-w-[340px] md:min-w-[480px] py-4 px-9 m-auto block text-white bg-[rgba(255,255,255,0.13)] backdrop-blur-md border-2 border-[rgba(255,255,255,0.13)] rounded-xl shadow-lg shadow-[rgba(8,7,16,0.6)] z-1 before:content-[''] before:size-36 md:before:size-44 before:bg-gradient-to-tr before:from-[#8a66d6] before:to-[#4141e2] before:-ml-[100px] md:before:-ml-[125px] before:-mt-[80px] md:before:-mt-[100px] before:blur-[0.5px] before:rounded-full before:absolute" >
